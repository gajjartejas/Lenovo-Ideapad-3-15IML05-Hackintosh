 ...
 *
 * Disassembly of SSDT-3.aml, Sun Apr  9 18:20:29 2023
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000B70 (2928)
 *     Revision         0x02
 *     Checksum         0xE1
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
        ...
        Device (PTID)
        {
            ...
            Method (TSDD, 0, Serialized)
            {
                If (LEqual (TSDB, One))
                {
                    ...
                    Store (Add (Multiply (\_SB.PDTS, 0x0A), 0x0AAC), Local0)
                    Store (Local0, Index (TMPX, Zero))
                    Store (Local0, Index (TMPX, One))
                    Store (Local0, Index (TMPX, 0x02))
                ...
                Store (Add (Multiply (\_SB.PDTS, 0x0A), 0x0AAC), Local0)
                Store (Local0, Index (TMPV, Zero))
                Store (Local0, Index (TMPV, One))
